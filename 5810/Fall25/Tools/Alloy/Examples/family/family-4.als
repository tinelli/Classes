...
fact {
    ...
    all p: Person | p.siblings = {q: Person - p | p.parents = q.parents}
...
check parentsArentSiblings for 20
...
-- There is no defined bound on the number of atoms in the instance, so the 
